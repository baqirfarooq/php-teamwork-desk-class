...
class TeamworkDesk
{
     ...
     */
    public function __construct(Guzzle $client, $key = null, $url = null)
    {
        $this->client = $client;
        $this->key = config("services.teamwork-desk.key");
        $this->url = config("services.teamwork-desk.url");
        $this->version = config("services.teamwork-desk.version");
    }
    ...
    {
        return $this->buildRequest($endpoint, 'GET', [], $query)->response();
    ...
    {
        return $this->buildRequest($endpoint, 'POST', $data)->response();
    }
    ...
    {
        return $this->buildRequest($endpoint, 'PUT', $data)->response();
    }
    ...
    {
        return $this->buildRequest($endpoint, 'DELETE')->response();
    }
    ...
    public function buildRequest($endpoint, $action, $params = [], $query = null)
    {
        ...
        try {
            $this->request = $this->client->request($action, $this->buildUrl($endpoint), $options);
